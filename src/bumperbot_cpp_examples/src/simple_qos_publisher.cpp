...
public:
  SimpleQoSPublisher() : Node("simple_qos_publisher"), counter_(0), qos_profile_pub_(10)
  {
    ...
    if(reliability == "best_effort"){
        ...
        RCLCPP_ERROR_STREAM(get_logger(), "Selected Realiability QoS: " << reliability << "doesn't exist!");           
        return;
    }
    ...
    if(durability == "volatile"){
        ...
        RCLCPP_INFO(get_logger(), "[Durability]: Trainsient Local");   
        ...
        RCLCPP_ERROR_STREAM(get_logger(), "Selected Duarbility QoS: " << durability << "doesn't exist!");
        return;           
    }
