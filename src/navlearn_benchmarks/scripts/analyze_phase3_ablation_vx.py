...
def verdict(high_vx_pct: float, base_pct: float, agg_pct: float, p_vs_base: float, p_vs_agg: float) -> str:
...
def main() -> int:
    ...
    # Pretty print
    print("=" * 76)
    print("Phase 3 vx_max Ablation — mppi_baseline_high_vx (= mppi_baseline + vx_max 0.45)")
    print("=" * 76)
    for mode in MODES:
