...
def seed():
    """Load the Python seed reference module by path."""
    path = os.path.join(PACKAGE_DIR, "scripts", "navlearn_seed.py")
    spec = importlib.util.spec_from_file_location("navlearn_seed", path)
